import  CodingSkillModel from '../Models/CodingSkills.js';

export const createCodingSkill = async  (req,res) =>{
    try {
     const data = req.body   
...
//edit contact
export const getCodingSkillbyId = async (req,res)=>{
    try {
    ...
    // lister contact
    export const getallCodingSkills = async (req,res) =>{
        try {
    ...
    //Delete contact
    export const deleteCodingSkill = async (req,res)=>{
        try {
        const param = req.params.id
...
export const updateCodingSkill = async (req, res) => {
    try {
        const param = req.params.id
      const data = req.body;
